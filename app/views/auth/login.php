    ...
    <div class="w-full max-w-5xl grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch">
        <section class="bg-surface-container-lowest p-8 md:p-12 rounded-xl shadow-[0_40px_40px_-15px_rgba(25,28,24,0.04)] border border-outline-variant/10">
            ...
            <div class="flex border-b border-outline-variant/20 mb-8">
                <a href="index.php?mod=auth&act=login" 
                   class="flex-1 py-3 text-center text-sm font-bold uppercase tracking-widest text-primary border-b-2 border-primary">
                   Sign In
                </a>
                <a href="index.php?url=register"
                   class="flex-1 py-3 text-center text-sm font-bold uppercase tracking-widest text-on-surface-variant/40 hover:text-primary transition-colors">
                   Join Zentro
                </a>
            </div>
            ...
            <form action="index.php?url=login" method="POST" class="space-y-6">
                <div class="space-y-2">
                    ...
                    <input name="email" required 
                           class="w-full bg-surface-container-high border-none rounded-lg p-4 focus:ring-1 focus:ring-primary/30 focus:bg-surface-container-lowest transition-all placeholder:text-outline"
                           placeholder="nature@zentro.com" type="email" />
                </div>
                
                <div class="space-y-2">
                    <div class="flex justify-between items-center px-1">
                        <label class="block text-xs font-bold uppercase tracking-wider text-primary">Password</label>
                        <a class="text-xs text-secondary font-semibold hover:underline" 
                           href="index.php?url=forgot-password">
                           Forgot Password?
                        </a>
                    </div>
            ...
            <div class="grid grid-cols-2 gap-4">
                <button class="flex items-center justify-center gap-3 bg-surface-container border border-outline-variant/20 py-3 rounded-lg hover:bg-surface-variant transition-colors">
        ...
        <section class="hidden md:flex flex-col justify-between bg-primary-container text-on-primary-container p-12 rounded-xl relative overflow-hidden">
            ...
            <div class="relative z-10 bg-surface/10 backdrop-blur-md p-6 rounded-xl border border-white/10">
                <div class="flex items-center gap-4 mb-4">
                    ...
                    <div>
                        <p class="font-bold text-white">Already Signed In?</p>
                        <p class="text-xs text-on-primary-container/70">Continue as Elena Woods</p>
                    </div>
                </div>
                <a href="index.php?mod=customer&act=dashboard" 
                   class="block w-full text-center bg-surface text-primary font-bold py-3 rounded-lg hover:bg-surface-bright transition-all text-sm">
