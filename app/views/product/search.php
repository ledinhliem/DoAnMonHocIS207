...
<main class="max-w-7xl mx-auto px-8 py-12">
    ...
    <section class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-10">
      <!-- Product Card 1 -->
      <div class="group flex flex-col space-y-4 cursor-pointer" onclick="window.location.href='<?= BASE_URL ?>?url=product/detail&id=1'">
        <div
          ...
          <div
            ...
            ECO-CHOICE</div>
          <button
            class="absolute bottom-4 right-4 bg-white/90 backdrop-blur text-primary p-3 rounded-full opacity-0 translate-y-2 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300" onclick="event.stopPropagation(); addToCart(1)">
      ...
      <!-- 2 -->
      <div class="group flex flex-col space-y-4 cursor-pointer" onclick="window.location.href='<?= BASE_URL ?>?url=product/detail&id=2'">
        <div
          class="relative aspect-[4/5] overflow-hidden rounded-xl bg-surface-container-low transition-all group-hover:shadow-xl group-hover:shadow-primary/5">
          <img class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
      ...
      <!-- 3 -->
      <div class="group flex flex-col space-y-4 cursor-pointer" onclick="window.location.href='<?= BASE_URL ?>?url=product/detail&id=3'">
        <div
          class="relative aspect-[4/5] overflow-hidden rounded-xl bg-surface-container-low transition-all group-hover:shadow-xl group-hover:shadow-primary/5">
          <img class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
          ...
          <div
            ...
            BESTSELLER</div>
          <button
            class="absolute bottom-4 right-4 bg-white/90 backdrop-blur text-primary p-3 rounded-full opacity-0 translate-y-2 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300" onclick="event.stopPropagation(); addToCart(3)">
            <span class="material-symbols-outlined">add_shopping_cart</span>
          </button>
        </div>
        <div class="flex flex-col space-y-1">
      ...
      <!-- 4 -->
      <div class="group flex flex-col space-y-4 cursor-pointer" onclick="window.location.href='<?= BASE_URL ?>?url=product/detail&id=4'">
        <div
          class="relative aspect-[4/5] overflow-hidden rounded-xl bg-surface-container-low transition-all group-hover:shadow-xl group-hover:shadow-primary/5">
          <img class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
          ...
          <button
            class="absolute bottom-4 right-4 bg-white/90 backdrop-blur text-primary p-3 rounded-full opacity-0 translate-y-2 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300" onclick="event.stopPropagation(); addToCart(4)">
            <span class="material-symbols-outlined">add_shopping_cart</span>
          </button>
        </div>
        <div class="flex flex-col space-y-1">
