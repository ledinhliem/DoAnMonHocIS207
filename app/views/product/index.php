        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-16">
          ...
          <div class="group cursor-pointer" onclick="window.location.href='<?= BASE_URL ?>?url=product/detail&id=1'">
            <div class="relative aspect-[4/5] mb-6 overflow-hidden rounded-xl bg-surface-container">
              ...
              <!-- CTA thêm giỏ hàng -->
              <button
                class="absolute bottom-4 right-4 bg-primary text-on-primary p-3 rounded-full shadow-lg opacity-0 translate-y-4 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300" onclick="event.stopPropagation(); addToCart(1)">
          ...
          <div class="group cursor-pointer" onclick="window.location.href='<?= BASE_URL ?>?url=product/detail&id=2'">
            <div class="relative aspect-[4/5] mb-6 overflow-hidden rounded-xl bg-surface-container">
              ...
              <button
                class="absolute bottom-4 right-4 bg-primary text-on-primary p-3 rounded-full shadow-lg opacity-0 translate-y-4 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300" onclick="event.stopPropagation(); addToCart(2)">
                <span class="material-symbols-outlined">add_shopping_cart</span>
              </button>
            </div>
            <div class="flex justify-between items-start mb-2">
          ...
          <div class="group cursor-pointer" onclick="window.location.href='<?= BASE_URL ?>?url=product/detail&id=3'">
            <div class="relative aspect-[4/5] mb-6 overflow-hidden rounded-xl bg-surface-container">
              ...
              <button
                class="absolute bottom-4 right-4 bg-primary text-on-primary p-3 rounded-full shadow-lg opacity-0 translate-y-4 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300" onclick="event.stopPropagation(); addToCart(3)">
                <span class="material-symbols-outlined">add_shopping_cart</span>
              </button>
            </div>
            <div class="flex justify-between items-start mb-2">
          ...
          <div class="group cursor-pointer" onclick="window.location.href='<?= BASE_URL ?>?url=product/detail&id=4'">
            <div class="relative aspect-[4/5] mb-6 overflow-hidden rounded-xl bg-surface-container">
              ...
              <button
                class="absolute bottom-4 right-4 bg-primary text-on-primary p-3 rounded-full shadow-lg opacity-0 translate-y-4 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300" onclick="event.stopPropagation(); addToCart(4)">
                <span class="material-symbols-outlined">add_shopping_cart</span>
              </button>
            </div>
            <div class="flex justify-between items-start mb-2">
          ...
          <!-- Sản phẩm 5 -->
          <div class="group cursor-pointer" onclick="window.location.href='<?= BASE_URL ?>?url=product/detail&id=5'">
            <div class="relative aspect-[4/5] mb-6 overflow-hidden rounded-xl bg-surface-container">
              ...
              <button
                class="absolute bottom-4 right-4 bg-primary text-on-primary p-3 rounded-full shadow-lg opacity-0 translate-y-4 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300" onclick="event.stopPropagation(); addToCart(5)">
                <span class="material-symbols-outlined">add_shopping_cart</span>
              </button>
            </div>
            <div class="flex justify-between items-start mb-2">
          ...
          <!-- Sản phẩm 6 -->
          <div class="group cursor-pointer" onclick="window.location.href='<?= BASE_URL ?>?url=product/detail&id=6'">
            <div class="relative aspect-[4/5] mb-6 overflow-hidden rounded-xl bg-surface-container">
              ...
              <button
                class="absolute bottom-4 right-4 bg-primary text-on-primary p-3 rounded-full shadow-lg opacity-0 translate-y-4 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300" onclick="event.stopPropagation(); addToCart(6)">
                <span class="material-symbols-outlined">add_shopping_cart</span>
              </button>
            </div>
            <div class="flex justify-between items-start mb-2">
