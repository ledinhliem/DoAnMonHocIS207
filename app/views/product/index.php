      ...
      <section class="flex-1">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-16">
          ...
          <div class="group">
            ...
            <div class="flex justify-between items-start mb-2">
              <a href="<?= BASE_URL ?>?url=product/detail&id=2" class="block">
          ...
          <div class="group">
            ...
            <div class="flex justify-between items-start mb-2">
              <a href="<?= BASE_URL ?>?url=product/detail&id=3" class="block">
          ...
          <div class="group">
            ...
            <div class="flex justify-between items-start mb-2">
              <a href="<?= BASE_URL ?>?url=product/detail&id=4" class="block">
          ...
          <div class="group">
            ...
            <div class="flex justify-between items-start mb-2">
              <a href="<?= BASE_URL ?>?url=product/detail&id=5" class="block">
          ...
          <div class="group">
            ...
            <div class="flex justify-between items-start mb-2">
              <a href="<?= BASE_URL ?>?url=product/detail&id=6" class="block">
