...
<main class="max-w-4xl mx-auto px-8 py-12">
    <h1 class="text-4xl font-black font-headline text-primary mb-8">Order Tracking</h1>
    ...
    <?php else: ?>
        <div class="bg-white rounded-2xl border border-outline-variant/30 p-6 space-y-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    <div class="text-sm text-on-surface-variant">Payment</div>
            ...
            <div class="rounded-2xl bg-surface-container p-5">
                ...
                <ul class="space-y-2 text-sm">
                    <li>✓ Order placed</li>
                    <li>✓ Payment confirmed / waiting COD</li>
