...
<head>
  ...
  <title>Zentro | Purchase History</title>
  <meta content="width=device-width, initial-scale=1.0" name="viewport" />
...
<body class="bg-surface text-on-surface font-body selection:bg-primary-fixed selection:text-on-primary-fixed">
  ...
  <main class="max-w-7xl mx-auto px-8 py-12">
    <header class="mb-16 flex flex-col md:flex-row md:items-end justify-between gap-8">
      <div class="max-w-2xl">
        <h1 class="text-5xl md:text-7xl font-headline font-extrabold text-on-surface tracking-tighter mb-4">Your conscious journey.</h1>
        <p class="text-body-lg text-on-surface-variant max-w-lg leading-relaxed">Review your past choices and their positive impact on the planet. Each order is a step towards a zero-waste lifestyle.</p>
      </div>
      <div class="bg-primary-container p-8 rounded-xl shadow-sm text-on-primary-container flex flex-col justify-between min-w-[320px] relative overflow-hidden group">
        <div class="absolute top-0 right-0 p-4 opacity-10 group-hover:scale-110 transition-transform duration-700">
          <span class="material-symbols-outlined text-9xl" data-icon="eco">eco</span>
        </div>
        <div>
          <span class="bg-surface-tint/20 px-3 py-1 rounded-full text-xs font-bold tracking-widest uppercase mb-4 inline-block">Impact Summary</span>
      ...
      <section class="lg:col-span-9 space-y-6">
        <div class="bg-surface-container-lowest p-6 rounded-xl flex flex-col md:flex-row gap-6 items-start md:items-center transition-all hover:bg-surface-container-low border border-outline-variant/5">
          <div class="w-full md:w-24 h-24 bg-surface-container rounded-lg overflow-hidden flex-shrink-0">
            <img class="w-full h-full object-cover" data-alt="set of aesthetic bamboo utensils and glass containers on a neutral linen cloth" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBdspvspYmf0Ap8mfiqUgR61Sxjjnx8egxnscvIFEHNaBkdCvCcyp1Z8ws4Mt2QEIVJDfrNtp1YsL2EgLy_DrwK6Ko40RjhwIM95OY6PYISM0RXLKIqFm1N_kyivkm7IGyCzUuDIXIfXuSFuu8BsWsQE1-inP3X7zOp3tcI1VZHAy_fvpdwxAdSyZtZ0YTtR1lPKzvhrVQw0hwSG2QE4mHforUkWgTNnti22Ipeg4ybm7bzm37Rn2fRCYGryt4TuN-pX5urLcW-icM" />
          </div>
          <div class="flex-grow">
            <div class="flex flex-wrap items-center gap-3 mb-1">
              ...
              <span class="px-3 py-1 bg-primary/10 text-primary text-[10px] font-bold uppercase tracking-widest rounded-full flex items-center gap-1">
                <span class="material-symbols-outlined text-sm" data-icon="local_shipping">local_shipping</span>
                In-Transit
              </span>
            </div>
          ...
          <div class="text-left md:text-right w-full md:w-auto">
            ...
            <div class="flex md:flex-col gap-2">
              <a href="<?= $base ?>?url=order/tracking" class="flex-1 bg-surface-container-high text-on-surface px-6 py-2 rounded-lg font-bold text-sm hover:bg-surface-variant transition-colors text-center block">Track Order</a>
            </div>
          </div>
        </div>
        ...
        <div class="bg-surface-container-lowest p-6 rounded-xl flex flex-col md:flex-row gap-6 items-start md:items-center transition-all hover:bg-surface-container-low border border-outline-variant/5">
          <div class="w-full md:w-24 h-24 bg-surface-container rounded-lg overflow-hidden flex-shrink-0">
            <img class="w-full h-full object-cover" data-alt="minimalist bathroom setting with organic cotton towels and wooden body brushes in soft morning light" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCFWgF9H8vW4pXEp4NDQ84b7hFLUINSLlTDgTM-imGMlWGN4j1BZo3KYFnIuGy9hoc1-iGCVIGRvneCCvd6N9mrYcJmqeaGHsaSwSWwyb1uKoQd5fqCXqcvTsXIfd1tNEkei8ItvjhiyS2NMlKPaWAKEPYN4LSuDmO_wvfYCmBMva5kj1JYAHp8b98LmoB9tDlUupEChjTkepV8ye00320a4m8OMtZYKhirRvuXF7PLIWTD2qudD7pT6XdBAB6lQLQLE7IhsqcyIac" />
          </div>
          <div class="flex-grow">
            <div class="flex flex-wrap items-center gap-3 mb-1">
        ...
        <div class="bg-surface-container-lowest p-6 rounded-xl flex flex-col md:flex-row gap-6 items-start md:items-center transition-all hover:bg-surface-container-low border border-outline-variant/5">
          <div class="w-full md:w-24 h-24 bg-surface-container rounded-lg overflow-hidden flex-shrink-0">
            <img class="w-full h-full object-cover" data-alt="collection of reusable ceramic coffee cups in earth tones stacked on a wooden shelf" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBgTDCViCZ4SvNTVkxjJevdlKtzPlKziO6qaVjbixzES8oyDiSbgqFx0sUU9pv6xg4QW3tGEL02t24Y-z5spWMrGa9inlFYphoFEMzlFMV0AqiLBurz-TyFegX3XG8jVXQ8HxZWsqVm9IKNPNezbHTihvWBFTQc2VEjczStlI02l0DBdBVGv79LxOl3546q-_jJzvJbrrdI1DjUhbl7AsnQPiPFE0xhSgZoxXrDvYyE1Y9jFsPGTRSOaBQqzCg7c9olYqW80-9WVo4" />
          </div>
          <div class="flex-grow">
            <div class="flex flex-wrap items-center gap-3 mb-1">
