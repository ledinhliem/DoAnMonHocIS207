...
<main>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                <div class="order-2 md:order-1">
                    ...
                    <div class="flex items-center gap-8">
                        <button class="px-8 py-4 bg-primary text-on-primary rounded-lg font-bold shadow-lg hover:opacity-90 transition-opacity" onclick="window.location.href='<?= BASE_URL ?>?url=product/detail&id=1'">Pre-order Now</button>
    ...
    <section class="py-24 max-w-7xl mx-auto px-8">
        <div class="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
            <div class="max-w-xl">
                <h2 class="font-headline text-4xl md:text-5xl font-extrabold text-on-background mb-4">Featured Products</h2>
                <p class="text-on-surface-variant text-lg">Discover our most loved sustainable essentials, carefully curated for conscious living.</p>
            </div>
            <a class="text-primary font-bold flex items-center gap-2 group border-b border-transparent hover:border-primary transition-all" href="<?= BASE_URL ?>?url=product">
                View All Products <span class="material-symbols-outlined group-hover:translate-x-1 transition-transform">arrow_forward</span>
            </a>
        </div>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <!-- Product 1 -->
            <div class="group cursor-pointer" onclick="window.location.href='<?= BASE_URL ?>?url=product/detail&id=1'">
                <div class="relative aspect-[4/5] mb-6 overflow-hidden rounded-xl bg-surface-container">
                    <img alt="Artisan Ceramic Vase" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" data-alt="Minimalist handcrafted ceramic vase on a raw wooden table with soft morning sunlight casting organic shadows" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDqlscwvuEWY7f0mxUdWJHnX5Mdim_-jOgGbl9EXgA68CmGDqEHQ4J_Z1qrXDt7-z-WMVU40kmotZKLaU5QfZ08DRO9KtaHTB_0S2kev8tNzvXNxljvDW1Uxg-L_VJl09MhuZYeF_PuggPMafHFC866Z4a2m9bK3Bhyn1aUG3UffiP8Uk3gXbUsKTjnGF3uYlAyMh4H1Ls8YcoCE3jCoixX_dGfyvsw6cYTW5EOpDaI-8_ywQhnFk-Ja3sjOrUDmL697Jr7C6oSEC8" />
                    <div class="absolute top-4 left-4">
                        <span class="bg-surface-container-lowest/90 backdrop-blur-md px-3 py-1 rounded-full text-[10px] font-bold tracking-widest uppercase text-primary">Limited Edition</span>
                    </div>
                    <button class="absolute bottom-4 right-4 bg-primary text-on-primary p-3 rounded-full shadow-lg opacity-0 translate-y-4 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300" onclick="event.stopPropagation(); addToCart(1)">
                        <span class="material-symbols-outlined">add_shopping_cart</span>
                    </button>
                </div>
                <div class="flex justify-between items-start mb-2">
                    <h3 class="text-lg font-bold text-on-surface group-hover:text-primary transition-colors">Terra Ceramic Vase</h3>
                    <span class="text-secondary font-bold text-lg">$84.00</span>
                </div>
                <div class="flex items-center gap-2 mb-4">
                    <div class="flex items-center gap-1 px-2 py-0.5 rounded-full bg-surface-tint/10 text-primary-container text-[10px] font-bold">
            ...
            <!-- Product 2 -->
            <div class="group cursor-pointer" onclick="window.location.href='<?= BASE_URL ?>?url=product/detail&id=2'">
                <div class="relative aspect-[4/5] mb-6 overflow-hidden rounded-xl bg-surface-container">
                    <img alt="Linen Cushion Set" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" data-alt="Handwoven organic linen cushions in earth tones arranged on a sustainable cork bench in a bright minimalist room" src="https://lh3.googleusercontent.com/aida-public/AB6AXuC3d37Lblu6zQC_Pzm05qHjofM_rWGxFrHeUpBjzLiioBiGxbj7MprwVJ-5Tee-b1TH_jOo94L_uSsZgrBeF99lbF6cJAiPIStCkVnxsz2529_uHEnKwRYKPQWBeVGPUmoY-Wiqqy24aprFb1YbHQdR7ziy4gz2IeTQnRNE3c6sMup6Wukx2RHZyOgFcF-KPp36ensxFy1L9_vO25u2QgxPcCp6Fj4wWKSE4pjTh5ecsUQ39r-rEW6mheBQ8jOCojUmJaKkOM9fBQ" />
                    <button class="absolute bottom-4 right-4 bg-primary text-on-primary p-3 rounded-full shadow-lg opacity-0 translate-y-4 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300" onclick="event.stopPropagation(); addToCart(2)">
                        <span class="material-symbols-outlined">add_shopping_cart</span>
                    </button>
                </div>
                <div class="flex justify-between items-start mb-2">
                    <h3 class="text-lg font-bold text-on-surface group-hover:text-primary transition-colors">Raw Linen Cushion Set</h3>
            ...
            <!-- Product 3 -->
            <div class="group cursor-pointer" onclick="window.location.href='<?= BASE_URL ?>?url=product/detail&id=3'">
                <div class="relative aspect-[4/5] mb-6 overflow-hidden rounded-xl bg-surface-container">
                    <img alt="Organic Cotton Towels" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" data-alt="A stack of folded organic cotton towels in sage green and cream colors on a stone shelf with a small eucalyptus branch" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAN8rGTSgawcW2iLdoNb19UMbi1MbYd1seInyTpaL07CVeEdfSmHRBgolhrftWd-BrXBsKxJanujtu-rwY8lCI-nN5WDONiRfFw1O-fDWoWIFZMb1RsLyM2VurZlTmIjdjDxeKMymj6pGPPwtpqszyhRsXYTuEtmFhsllbDI2_nUbJTxee-loLqTHsK8nSoceCuCZsJZRC8n0R8e6nCm5Wjb1fZC2wmjEYMfSJJsWflp8i7F4JHuZKhBBpQBFohFkDDUtwEV4tAFc" />
                    <div class="absolute top-4 left-4">
                        <span class="bg-secondary-container text-on-secondary-container px-3 py-1 rounded-full text-[10px] font-bold tracking-widest uppercase">Best Seller</span>
                    </div>
                    <button class="absolute bottom-4 right-4 bg-primary text-on-primary p-3 rounded-full shadow-lg opacity-0 translate-y-4 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300" onclick="event.stopPropagation(); addToCart(3)">
                        <span class="material-symbols-outlined">add_shopping_cart</span>
                    </button>
                </div>
                <div class="flex justify-between items-start mb-2">
                    <h3 class="text-lg font-bold text-on-surface group-hover:text-primary transition-colors">Cloud Cotton Bath Set</h3>
            ...
            <!-- Product 4 -->
            <div class="group cursor-pointer" onclick="window.location.href='<?= BASE_URL ?>?url=product/detail&id=4'">
                <div class="relative aspect-[4/5] mb-6 overflow-hidden rounded-xl bg-surface-container">
                    <img alt="Recycled Glass Carafe" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" data-alt="Modern recycled glass carafe and tumblers with a subtle green tint standing on a textured limestone surface" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBUhY1QhlHwwqBj9UM-TQtnrdo7d6LNuAvqv09lZmwTR4RkN-yGDKqxvUJRaUU7V3lCRsL5Gg-AHkxB3aPyewjGsMlXtEbxEh4mw8sI5sFX_0ro3-x5wz-8Cf50MMXF--7GqeTShSTqdrEeHeKFRdDwFxD1w2ZjflhPxoXwUvd89vid7wnHZbLc4wFFdvfhAcusoO-HKL55w_kIKre8XAJ4I0M4DjOdY28uaYY_OM_05OTfJZkV7L4NAh_ckOBi5t1aQq4L3HdK8pM" />
                    <button class="absolute bottom-4 right-4 bg-primary text-on-primary p-3 rounded-full shadow-lg opacity-0 translate-y-4 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300" onclick="event.stopPropagation(); addToCart(4)">
                        <span class="material-symbols-outlined">add_shopping_cart</span>
                    </button>
                </div>
                <div class="flex justify-between items-start mb-2">
                    <h3 class="text-lg font-bold text-on-surface group-hover:text-primary transition-colors">Fluted Glass Carafe</h3>
