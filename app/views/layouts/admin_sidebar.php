<aside
    class="h-screen w-64 fixed left-0 top-0 bg-[#edefe7] dark:bg-stone-800 border-r border-[#c5c8ba]/20 shadow-[40px_0_40px_-15px_rgba(25,28,24,0.04)] z-50 flex flex-col py-8">
    <div class="px-6 mb-10">
        <h1 class="font-['Epilogue'] font-black text-[#384e21] text-2xl tracking-tighter">Zentro Admin</h1>
        <p class="font-['Be_Vietnam_Pro'] font-medium text-xs text-[#191c18]/60 mt-1 uppercase tracking-widest">Bộ quản
            trị xanh</p>
    </div>
    ...
    <div class="mt-auto px-4">
        <button
            class="w-full bg-[#384e21] text-white font-['Be_Vietnam_Pro'] text-sm py-3 rounded-xl flex items-center justify-center gap-2 hover:opacity-90 transition-opacity">
