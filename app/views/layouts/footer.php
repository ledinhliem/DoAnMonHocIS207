<footer class="w-full pt-16 pb-8 bg-surface-container text-primary font-body border-t border-outline-variant/10">
    <div class="grid grid-cols-2 md:grid-cols-4 gap-12 px-8 max-w-7xl mx-auto">
        ...
        <div>
            ...
            <ul class="space-y-4 text-sm text-on-surface-variant/80">
                <li><a class="hover:underline underline-offset-4 decoration-primary/30" href="index.php">Our Story</a>
                </li>
                <li><a class="hover:underline underline-offset-4 decoration-primary/30"
        ...
        <div>
            ...
            <ul class="space-y-4 text-sm text-on-surface-variant/80">
                ...
                <li><a class="hover:underline underline-offset-4 decoration-primary/30" href="index.php">Privacy
                        Policy</a></li>
                <!--xem có link face ins thì sửa lại-->
                <li><a class="hover:underline underline-offset-4 decoration-primary/30" href="index.php"
    ...
    <div
        ...
        <div class="flex gap-6">
            ...
            <a class="hover:text-primary transition-colors" href="/is207/cookies">Cookies</a>
        </div>
    </div>
</footer>
