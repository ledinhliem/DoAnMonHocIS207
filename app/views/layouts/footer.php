<footer class="w-full pt-16 pb-8 bg-surface-container text-primary font-body border-t border-outline-variant/10">
    <div class="grid grid-cols-2 md:grid-cols-4 gap-12 px-8 max-w-7xl mx-auto">
        ...
        <div>
            <h4 class="font-bold text-primary mb-6 uppercase text-xs tracking-widest">Cửa hàng</h4>
        ...
        <div>
            ...
            <ul class="space-y-4 text-sm text-on-surface-variant/80">
                <li><a class="hover:underline underline-offset-4 decoration-primary/30"
                        href="index.php?url=ourstory">Our Story</a></li>
                <li><a class="hover:underline underline-offset-4 decoration-primary/30"
                        href="index.php?url=sustainability">Sustainability</a></li>
                <li><a class="hover:underline underline-offset-4 decoration-primary/30"
                        href="index.php?url=blog">Blog</a></li>
            </ul>
        </div>
        ...
        <div>
            ...
            <ul class="space-y-4 text-sm text-on-surface-variant/80">
                <li><a class="hover:underline underline-offset-4 decoration-primary/30"
                        href="mailto:contact@zentro.com">Email: contact@zentro.com</a></li>
                <li><a class="hover:underline underline-offset-4 decoration-primary/30"
                        href="tel:0909090090">Tel: 0909 090 090 (8:00 – 21:30)</a></li>
                <li><a class="hover:underline underline-offset-4 decoration-primary/30"
                        href="https://www.instagram.com/daiu.laz?igsh=dndlc2d6N3Q0YzQz&utm_source=qr" target="_blank">Instagram</a></li>
                <li><a class="hover:underline underline-offset-4 decoration-primary/30"
                        href="https://www.facebook.com/profile.php?id=61589733862899" target="_blank">Facebook</a></li>
            </ul>
        </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-8 mt-16 pt-8 border-t border-primary/10
        ...
        <div class="flex gap-6">
            <a class="hover:text-primary transition-colors" href="index.php?url=terms">Terms</a>
            <a class="hover:text-primary transition-colors" href="index.php?url=privacy">Privacy</a>
            <a class="hover:text-primary transition-colors" href="index.php?url=cookies">Cookies</a>
        </div>
    </div>
</footer>
