...
<section class="max-w-7xl mx-auto px-6 md:px-8 py-12 md:py-16">
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
        <div class="lg:col-span-7 space-y-6">
            ...
            <div class="space-y-5" data-cart-list>
                <div class="cart-item bg-white rounded-xl p-6 shadow-soft border border-outline-variant/10 flex flex-col md:flex-row gap-6" data-price="84">
                    ...
                    <div class="flex-1 flex flex-col justify-between gap-4">
                        <div class="flex items-start justify-between gap-4">
                            ...
                            <button type="button" class="btn-remove-item text-red-500 hover:text-red-700 font-medium">Xóa</button>
                        </div>
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-4 bg-surface-container-high px-4 py-2 rounded-full">
                                <button type="button" class="btn-qty-minus"><span class="material-symbols-outlined text-sm">remove</span></button>
                                <span class="cart-qty font-bold">1</span>
                                <button type="button" class="btn-qty-plus"><span class="material-symbols-outlined text-sm">add</span></button>
                            </div>
                            <span class="cart-item-total font-headline text-xl font-bold">$84.00</span>
                        </div>
                    </div>
                </div>

                <div class="cart-item bg-white rounded-xl p-6 shadow-soft border border-outline-variant/10 flex flex-col md:flex-row gap-6" data-price="78">
                    <div class="w-full md:w-28 h-32 rounded-xl overflow-hidden bg-surface-container">
                    ...
                    <div class="flex-1 flex flex-col justify-between gap-4">
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-4 bg-surface-container-high px-4 py-2 rounded-full">
                                <button type="button" class="btn-qty-minus"><span class="material-symbols-outlined text-sm">remove</span></button>
                                <span class="cart-qty font-bold">2</span>
                                <button type="button" class="btn-qty-plus"><span class="material-symbols-outlined text-sm">add</span></button>
                            </div>
                            <span class="cart-item-total font-headline text-xl font-bold">$156.00</span>
                        </div>
                    </div>
                </div>
            </div>

            <div class="hidden text-center py-10" data-cart-empty>
                <h3 class="text-2xl font-bold text-primary mb-2">Giỏ hàng trống</h3>
                <p class="text-on-surface-variant mb-4">Bạn chưa có sản phẩm nào trong giỏ.</p>
                <a href="<?= BASE_URL ?>" class="inline-block bg-primary text-white px-6 py-3 rounded-lg font-bold">
                    Tiếp tục mua sắm
                </a>
            </div>
            ...
            <div class="bg-surface-container-low rounded-xl p-8 shadow-soft sticky top-28">
                ...
                <div class="space-y-3 text-on-surface-variant">
                    <div class="flex justify-between">
                        <span>Subtotal</span>
                        <span data-cart-subtotal>$240.00</span>
                    </div>
                    <div class="flex justify-between">
                        <span>Carbon-Neutral Shipping</span>
                        <span data-cart-shipping class="text-primary font-medium">Free</span>
                    </div>
                    <div class="flex justify-between pt-4 text-on-surface text-xl font-headline font-bold border-t border-outline-variant/20">
                        <span>Total</span>
                        <span data-cart-total>$240.00</span>
                    </div>
                </div>

                <div class="mt-8 space-y-3">
                    <a href="<?= BASE_URL ?>?url=checkout" class="block w-full text-center bg-secondary hover:bg-[#5d4123] text-on-secondary py-4 rounded-lg font-headline font-bold transition-all">
                        Checkout
                    </a>
